...
from config import settings, WORK_SCHEMA
...
def include_name(name, type_, parent_names):
    if type_ == "schema":
        return name in [WORK_SCHEMA]
    else:
        return True


configure_opts = dict(target_metadata=target_metadata,
                      version_table_schema=WORK_SCHEMA,
